        ...
        <div class="column is-four-fifths">
            <div class="container">
                <div id="profile" class="container form-detail">
                    ...
                    <div class="container content">
                        <form id="property-form" method="post" action="<?= site_url('user_typical_non_ribbon/action_get_ribbon_amount') ?>" target="_blank">
...
<script>
    $(document).ready(function() {
        ...
        const init_func = function() {
            ...
            $("a#user-typical-non-ribbon-amount-person").addClass('is-active');
        };
        init_func();
