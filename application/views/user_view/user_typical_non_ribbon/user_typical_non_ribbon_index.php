        ...
        <div class="column is-four-fifths">
            <div class="container">
                <div id="profile" class="container form-detail">
                    ...
                    <div class="container content">
                        <form id="property-form" method="post" action="<?= site_url('user_typical_non_ribbon/action_get_non_ribbon_person_prop') ?>" target="_blank">
...
<script>
    $(document).ready(function() {
        ...
        const init_func = function() {
            ...
            $("a#user-typical-non-ribbon-property").addClass('is-active');
        };
        init_func();
