...
<aside class="menu">
    ...
    <ul class="menu-list">
        ...
        <li><a id="summarize-name-ul-ribbon" href="<?= site_url('user_ribbon/summarize_name_form') ?>">พิมพ์สรุปราบชื่อ</a></li>
    ...
    <ul class="menu-list">
        ...
        <li><a id="summarize-name-ul-nonribbon" href="<?= site_url('user_non_ribbon/summarize_name') ?>">พิมพ์สรุปราบชื่อ</a></li>
