            ...
            <div class="container">
                <div id="profile" class="container form-detail">
                    ...
                    <div class="container content">
                        ...
                        <div class="is-size-5">พิมพ์บัญชีสรุปจำนวน</div>
                        <div class="is-size-6">
                            สถานะ
                    ...
                    <div class="container content">
                        <form id="property-form" method="post" action="<?= site_url('admin_typical_non_ribbon_status_off/action_get_ribbon_amount') ?>" target="_blank">
...
<script>
    $(document).ready(function() {
        ...
        $("a#admin-typical-non-ribbon-amount-person").addClass('is-active');
